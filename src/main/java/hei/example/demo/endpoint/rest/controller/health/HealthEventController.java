package hei.example.demo.endpoint.rest.controller.health;

import static hei.example.demo.endpoint.rest.controller.health.PingController.KO;
import static hei.example.demo.endpoint.rest.controller.health.PingController.OK;
import static java.util.UUID.randomUUID;

import hei.example.demo.PojaGenerated;
import hei.example.demo.endpoint.event.EventProducer;
import hei.example.demo.endpoint.event.model.DurablyFallibleUuidCreated1;
import hei.example.demo.endpoint.event.model.UuidCreated;
import hei.example.demo.repository.DummyUuidRepository;
import hei.example.demo.repository.model.DummyUuid;
