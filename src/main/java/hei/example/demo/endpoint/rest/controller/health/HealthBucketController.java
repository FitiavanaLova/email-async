...
import static hei.example.demo.file.hash.FileHashAlgorithm.NONE;
import static java.io.File.createTempFile;
import static java.nio.file.Files.createTempDirectory;
import static java.util.UUID.randomUUID;

import hei.example.demo.PojaGenerated;
import hei.example.demo.file.bucket.BucketComponent;
import hei.example.demo.file.hash.FileHash;
import java.io.File;
