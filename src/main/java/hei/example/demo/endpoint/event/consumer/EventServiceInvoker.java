package hei.example.demo.endpoint.event.consumer;

import hei.example.demo.PojaGenerated;
import hei.example.demo.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("hei.example.demo.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "hei.example.demo.service.event."
