package hei.example.demo.endpoint.event.model;

import static hei.example.demo.endpoint.event.EventStack.EVENT_STACK_1;
import static java.lang.Math.random;

import hei.example.demo.PojaGenerated;
import hei.example.demo.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    return "hei.example.demo.event1";
  }
}
